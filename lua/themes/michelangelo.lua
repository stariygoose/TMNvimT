-- Michelangelo - Весельчак с оранжевыми тонами
-- Черно-белая комикс-графика с оранжевым акцентом
...
M.colors = {
  ...
  -- Michelangelo colors (оранжевый акцент)
  turtle_green = "#ff8c00",      -- Темно-оранжевый
  neon_green = "#ffa500",        -- Яркий оранжевый
  dark_green = "#d2691e",        -- Шоколадный
  ...
  -- Accents
  orange = "#ffdab9",            -- Персиковый
  yellow = "#ff6347",            -- Томатный
...
M.setup = function()
  ...
  vim.g.colors_name = "michelangelo"
