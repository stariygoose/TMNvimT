-- Leonardo - Лидер с синими тонами
-- Черно-белая комикс-графика с синим акцентом
...
M.colors = {
  ...
  -- Leonardo colors (синий акцент)
  turtle_green = "#4169e1",      -- Королевский синий
  neon_green = "#1e90ff",        -- Океанский синий
  dark_green = "#0b3d91",        -- Глубокий синий
  ...
  -- Accents
  orange = "#87ceeb",            -- Ледяной синий
  yellow = "#5f9ea0",            -- Серо-синий
